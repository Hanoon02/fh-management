  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-center transition-all duration-300">
        <img
          className={`w-full h-16 md:h-28 object-contain rounded-md transition-all duration-300 ${
      ...
      {isHovered && (
        <div className="absolute inset-0 flex flex-col items-center justify-end text-center pb-8">
          ...
          <button onClick={onClick} className="bg-[#3fada8] text-white px-4 py-2 rounded-md hover:bg-[#338a86]">
            Open Application
          </button>
        </div>
      )}
